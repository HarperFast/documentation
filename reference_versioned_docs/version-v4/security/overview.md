...
- [mTLS Authentication](./mtls-authentication.md) — Mutual TLS certificate-based authentication. Added in: v4.3.0
...
- [Certificate Verification](./certificate-verification.md) — Certificate revocation checking via CRL and OCSP. Added in: v4.7.0 (OCSP support)

## Access Control

- [CORS](./cors.md) — Cross-Origin Resource Sharing configuration.
- [SSL / HTTPS](./ssl.md) — Enabling HTTPS and configuring TLS for the HTTP server.
