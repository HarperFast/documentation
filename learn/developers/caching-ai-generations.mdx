...
- [Resource API](/reference/v4/resources/resource-api) — `sourcedFrom`, `invalidate`, `getContext`, static methods
- [Database Schema](/reference/v4/database/schema) — `@table(expiration:)` directive reference
- [REST Headers](/reference/v4/rest/headers) — ETag, `If-None-Match`, `Cache-Control` directives
