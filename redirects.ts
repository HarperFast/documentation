...
const currentRedirects: RedirectRule[] = [
	...
	{ from: '/docs/developers/operations-api/sql-operations', to: '/reference/v5/operations-api/sql' },
	...
	{ from: '/docs/developers/sql-guide', to: '/reference/v5/operations-api/sql' },

	{ from: '/docs/developers/sql-guide/functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/developers/sql-guide/date-functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/developers/sql-guide/features-matrix', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/developers/sql-guide/json-search', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/developers/sql-guide/sql-geospatial-functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/developers/sql-guide/reserved-word', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/sql-support', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/sql-guide/insert', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/sql-guide/select', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/sql-guide/datatypes', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/sql-guide/sql-geospatial-functions/geoconvert', to: '/reference/v5/operations-api/sql' },
	...
	{ from: '/docs/reference/sql-guide', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/json-search', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/date-functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/sql-geospatial-functions', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/reserved-word', to: '/reference/v5/operations-api/sql' },
	{ from: '/docs/reference/sql-guide/features-matrix', to: '/reference/v5/operations-api/sql' },
